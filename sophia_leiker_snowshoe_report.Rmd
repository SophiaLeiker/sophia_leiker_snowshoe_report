...
**Table 2.** Descriptive statistics (mean, median, standard deviation, min, and max) for juvenile female hares
```{r}
hare_females_stats %>% 
...
**Table 3.** Descriptive statistics (mean, median, standard deviation, min, and max) for juvenile male hares
```{r}
hare_males_stats %>% 
