...
**Table 2.** Descriptive Statistics for Juvenile Female Hare Weights vs Juvenile Male Weights (mean, median, standard deviation, min, and max) 
```{r}
female_male_stats %>% 
...
**Table 3.** Descriptive Statistics for Juvenile Female Hare Weights by Site (mean, median, standard deviation, min, and max)
```{r}
hare_females_stats %>% 
...
**Table 4.** Descriptive Statistics for Juvenile Male Hare Weights by Site (mean, median, standard deviation, min, and max)
```{r}
hare_males_stats %>% 
